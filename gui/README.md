...
Version `0.1.0-beta.3` remains published as [`desktop-v0.1.0-beta.3`](https://github.com/Jia-Ethan/grok-keysmith/releases/tag/desktop-v0.1.0-beta.3). This source tree prepares the unreleased `0.1.0-beta.4` prerelease with the stable CLI `0.5.0` sidecar. Formal installers must be rebuilt from the final `desktop-v0.1.0-beta.4` tag before publication.

- Planned macOS candidate: `grok-keysmith_0.1.0-beta.4_aarch64.dmg`
- Planned Windows candidate: `grok-keysmith_0.1.0-beta.4_x64-setup.exe`
