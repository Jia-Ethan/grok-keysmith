...
1. **Conservative: stable CLI.** Use the complete ZIP / Tarball from the [latest stable Release](https://github.com/Jia-Ethan/grok-keysmith/releases/latest) (currently `v0.5.1`), or check out the same tag. `run` and `breaktest` require sibling modules, so do not download only `grok-keysmith.py` or install from floating `main`.
...
```bash
curl -LO https://github.com/Jia-Ethan/grok-keysmith/releases/download/v0.5.1/grok-keysmith-v0.5.1.zip
curl -LO https://github.com/Jia-Ethan/grok-keysmith/releases/download/v0.5.1/SHA256SUMS
grep ' grok-keysmith-v0.5.1.zip$' SHA256SUMS | shasum -a 256 -c -
unzip grok-keysmith-v0.5.1.zip
cd grok-keysmith-v0.5.1
...
```bash
git clone --branch v0.5.1 --depth 1 https://github.com/Jia-Ethan/grok-keysmith.git
cd grok-keysmith
python3 grok-keysmith.py --version
python3 grok-keysmith.py --status
python3 grok-keysmith.py --dry-run
...
- Versions and assets live on [Releases](https://github.com/Jia-Ethan/grok-keysmith/releases). `v0.5.1` provides `--json`, `--grok-dir`, `run`, `breaktest`, and `--reconcile`.
