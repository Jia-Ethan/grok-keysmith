...
Current `main` contains CLI development version `0.4.0-dev` and Desktop `0.1.0-beta.1`; neither is a published release. Formal installation remains pinned to `v0.3.0` below.
